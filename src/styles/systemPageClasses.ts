export const systemStyles = {
  ...
  heroAside:
    "grid gap-[0.65rem] rounded-lg border border-border bg-surface-strong p-[clamp(1.25rem,3vw,2rem)] shadow-brand-sm [&_strong]:font-display [&_strong]:text-[1.6rem] [&_strong]:text-primary-strong",
  panel:
    "grid min-h-52 content-start rounded-lg border border-border bg-surface-strong p-[clamp(1.25rem,3vw,2rem)] shadow-brand-sm [&_h2]:mt-[0.65rem] [&_h2]:mb-0 [&_h2]:font-display [&_h2]:text-[clamp(1.8rem,4vw,3rem)] [&_h2]:leading-[1.08] [&_h2]:text-primary-strong [&_h3]:mt-3 [&_h3]:mb-0 [&_h3]:text-[1.2rem] [&_h3]:text-primary-strong [&_p]:mt-3 [&_p]:mb-0 [&_p]:leading-[1.68] [&_p]:text-text-muted",
  formPanel:
    "rounded-lg border border-border bg-surface-strong p-[clamp(1.25rem,3vw,2rem)] shadow-brand-sm [&_h2]:mt-[0.65rem] [&_h2]:mb-0 [&_h2]:font-display [&_h2]:text-[clamp(1.8rem,4vw,3rem)] [&_h2]:leading-[1.08] [&_h2]:text-primary-strong",
  thankYouPanel:
    "mx-auto my-16 max-w-[48rem] rounded-lg border border-border bg-surface-strong p-[clamp(1.25rem,3vw,2rem)] text-center shadow-brand-sm [&_h1]:mt-[0.65rem] [&_h1]:mb-0 [&_h1]:font-display [&_h1]:text-[clamp(1.8rem,4vw,3rem)] [&_h1]:leading-[1.08] [&_h1]:text-primary-strong",
  qrPanel:
    "mx-auto my-16 grid max-w-[48rem] justify-items-center gap-4 rounded-lg border border-border bg-surface-strong p-[clamp(1.25rem,3vw,2rem)] text-center shadow-brand-sm [&_h1]:mt-[0.65rem] [&_h1]:mb-0 [&_h1]:font-display [&_h1]:text-[clamp(1.8rem,4vw,3rem)] [&_h1]:leading-[1.08] [&_h1]:text-primary-strong",
  ...
  secondaryButton:
    "inline-flex min-h-[2.85rem] items-center justify-center gap-[0.55rem] rounded-full border border-border-strong bg-[#fffdf899] px-[1.1rem] py-3 text-[0.9rem] font-extrabold text-primary-strong no-underline transition duration-150 hover:-translate-y-px disabled:cursor-not-allowed disabled:opacity-60 disabled:hover:translate-y-0 max-[560px]:w-full",
  iconButton:
  ...
  productCard:
    "overflow-hidden rounded-lg border border-border bg-surface-strong text-inherit no-underline",
  productImage:
  ...
  fieldGroup:
    "grid gap-[0.45rem] [&_input]:w-full [&_input]:rounded-lg [&_input]:border [&_input]:border-border-strong [&_input]:bg-[#fffdf8b8] [&_input]:px-[0.9rem] [&_input]:py-[0.78rem] [&_input]:text-text [&_input]:outline-none [&_input:focus]:border-primary [&_input:focus]:shadow-[0_0_0_3px_rgba(31,95,68,0.15)] [&_label]:text-[0.88rem] [&_label]:font-extrabold [&_label]:text-primary-strong [&_select]:w-full [&_select]:rounded-lg [&_select]:border [&_select]:border-border-strong [&_select]:bg-[#fffdf8b8] [&_select]:px-[0.9rem] [&_select]:py-[0.78rem] [&_select]:text-text [&_select]:outline-none [&_select:focus]:border-primary [&_select:focus]:shadow-[0_0_0_3px_rgba(31,95,68,0.15)] [&_textarea]:min-h-32 [&_textarea]:w-full [&_textarea]:resize-y [&_textarea]:rounded-lg [&_textarea]:border [&_textarea]:border-border-strong [&_textarea]:bg-[#fffdf8b8] [&_textarea]:px-[0.9rem] [&_textarea]:py-[0.78rem] [&_textarea]:text-text [&_textarea]:outline-none [&_textarea:focus]:border-primary [&_textarea:focus]:shadow-[0_0_0_3px_rgba(31,95,68,0.15)]",
  choiceGroup:
