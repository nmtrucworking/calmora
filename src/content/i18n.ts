import type { BrandFooterGroup, BrandNavItem } from "../constants/brand";
...
const productCopy: Record<Language, Record<ProductId, ProductCopy>> = {
  vi: {
    classic: {
      ...
      shippingNote: "Dự kiến giao trong 3-5 ngày làm việc sau khi concierge xác nhận.",
      ...
      secondaryAction: { label: "Đăng ký đặt trước", href: "/dat-truoc?product=classic" },
  ...
  en: {
    classic: {
      ...
      secondaryAction: { label: "Join preorder", href: "/dat-truoc?product=classic" },
    ...
    "gift-set": {
      ...
      badges: ["Gifting", "Corporate", "Custom quote"],
      primaryAction: { label: "Request information", href: "/dat-truoc?product=gift-set" },
...
> = {
  vi: {
    ...
    services: {
      "/gifting": {
        ...
        blocks: [
          ...
          { title: "Delivery timing", text: "Concierge xác nhận ngày giao và điều kiện bảo quản trước khi chốt." },
        ],
      },
      "/corporate-gifting": {
        ...
        blocks: [
          { title: "Bulk inquiry", text: "Ghi nhận số lượng, ngân sách, nhóm người nhận và thời điểm giao." },
          { title: "Customization", text: "Tùy biến lời nhắn, ngôn ngữ, QR và dấu ấn thương hiệu đối tác." },
          { title: "Concierge review", text: "Mỗi cấu hình được đội ngũ Senova rà soát trước khi sản xuất." },
        ],
      },
      "/concierge": {
        path: "/concierge",
        ...
        blocks: [
          ...
          { title: "Aftercare", text: "Hướng dẫn bảo quản, pha trà và tiếp nhận phản hồi sau trải nghiệm." },
        ],
      },
      "/private-tasting": {
        ...
        blocks: [
          ...
          { title: "Follow-up", text: "Gửi tóm tắt cấu hình phù hợp sau buổi tasting." },
        ],
      },
    },
    policies: {
      "/shipping": {
        ...
        description: "Senova chưa mở checkout thanh toán tự động; mọi lịch giao được concierge xác nhận.",
        blocks: [
      ...
      "/returns": {
        ...
        description: "Trang chính sách mock cho giai đoạn preorder, ưu tiên liên hệ concierge trước khi xử lý.",
        blocks: [
    ...
    ui: {
      ...
      checkoutTitle: "Gửi yêu cầu, chưa thanh toán online.",
      ...
      submitting: "Đang gửi...",
      submitInquiry: "Gửi concierge inquiry",
      review: "Review",
      ...
      serviceAside: "Mọi yêu cầu được xử lý bằng concierge thay vì checkout tự động.",
