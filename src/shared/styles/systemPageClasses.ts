...
export const systemStyles = {
  ...
  panel:
    `grid min-h-52 content-start rounded-lg p-[clamp(1.25rem,3vw,2rem)] ${luxuryMotion.surface} ${luxuryMotion.cardHover} [&_h2]:mt-[0.65rem] [&_h2]:mb-0 [&_h2]:font-display [&_h2]:text-[clamp(1.8rem,4vw,3rem)] [&_h2]:leading-[1.08] [&_h2]:text-[var(--accent)] [&_h3]:mt-3 [&_h3]:mb-0 [&_h3]:text-[1.2rem] [&_h3]:text-text [&_p]:mt-3 [&_p]:mb-0 [&_p]:leading-[1.68] [&_p]:text-text-muted`,
  formPanel:
    `rounded-lg p-[clamp(1.25rem,3vw,2rem)] ${luxuryMotion.surface} [&_h2]:mt-[0.65rem] [&_h2]:mb-0 [&_h2]:font-display [&_h2]:text-[clamp(1.8rem,4vw,3rem)] [&_h2]:leading-[1.08] [&_h2]:text-text`,
  thankYouPanel:
    `mx-auto my-16 max-w-[48rem] rounded-lg p-[clamp(1.25rem,3vw,2rem)] text-center ${luxuryMotion.surface} [&_h1]:mt-[0.65rem] [&_h1]:mb-0 [&_h1]:font-display [&_h1]:text-[clamp(1.8rem,4vw,3rem)] [&_h1]:leading-[1.08] [&_h1]:text-text`,
  qrPanel:
  ...
  primaryButton:
    `inline-flex min-h-[2.85rem] items-center justify-center gap-[0.55rem] rounded-full border border-[var(--accent)] bg-[var(--accent)] px-[1.1rem] py-3 text-[0.9rem] font-extrabold text-[var(--senova-ink)] no-underline disabled:cursor-not-allowed disabled:opacity-60 disabled:hover:translate-y-0 hover:bg-[#ffe79e] hover:border-[#ffe79e] max-[560px]:w-full ${luxuryMotion.button}`,
  secondaryButton:
    `inline-flex min-h-[2.85rem] items-center justify-center gap-[0.55rem] rounded-full border border-border bg-transparent px-[1.1rem] py-3 text-[0.9rem] font-extrabold text-text no-underline disabled:cursor-not-allowed disabled:opacity-60 disabled:hover:translate-y-0 hover:bg-[var(--surface-strong)] max-[560px]:w-full ${luxuryMotion.button}`,
  iconButton:
    `inline-flex min-h-[2.85rem] items-center justify-center gap-[0.55rem] rounded-full border border-border bg-transparent px-[1.1rem] py-3 text-[0.9rem] font-extrabold text-text no-underline hover:bg-[var(--surface-strong)] ${luxuryMotion.button}`,
  sectionHeader:
    "max-w-[48rem] [&_h2]:mt-[0.65rem] [&_h2]:mb-0 [&_h2]:font-display [&_h2]:text-[clamp(1.8rem,4vw,3rem)] [&_h2]:leading-[1.08] [&_h2]:text-text",
  ...
  productImage:
    "grid aspect-[4/3] place-items-center bg-[radial-gradient(circle_at_50%_40%,rgba(248,223,147,0.1),transparent_38%),rgba(255,250,240,0.02)] [&_img]:h-auto [&_img]:w-[min(72%,16rem)] [&_img]:drop-shadow-[0_18px_28px_rgba(0,0,0,0.3)]",
  productBody:
  ...
  qrIcon: "h-12 w-12 text-[var(--accent)]",
} as const;
