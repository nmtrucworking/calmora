...
export const systemStyles = {
  ...
  iconButton:
    `inline-flex min-h-[2.85rem] items-center justify-center gap-[0.55rem] rounded-[var(--radius-sm)] border border-[rgba(138,104,37,0.24)] bg-[rgba(255,253,248,0.38)] px-[1.15rem] py-3 text-[0.9rem] font-extrabold tracking-normal text-text no-underline shadow-[0_10px_24px_rgba(37,31,21,0.07)] hover:border-[rgba(138,104,37,0.42)] hover:bg-[var(--surface-strong)] ${luxuryMotion.button}`,
  sectionHeader:
