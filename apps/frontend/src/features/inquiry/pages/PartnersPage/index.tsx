    ...
    <article className={styles.page}>
      <section className={`${styles.hero} ${styles.heroCompact}`}>
        ...
        <aside className={styles.heroAside}>
          ...
          <Link className={styles.secondaryButton} href="/team">{copy.teamLink}</Link>
        </aside>
      </section>
