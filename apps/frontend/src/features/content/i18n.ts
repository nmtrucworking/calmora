  ...
  vi: {
    ...
    "petal-pack": {
      ...
      experienceSteps: [
        ...
        { title: "Chờ", text: "Chờ 3 phút để hương và vị dần hiện ra; câu chuyện Petal Pack sẽ đồng hành trong lúc đợi." },
  ...
  en: {
    ...
    "petal-pack": {
      ...
      experienceSteps: [
        ...
        { title: "Wait", text: "Wait 3 minutes as the aroma and body appear; the Petal Pack story accompanies this pause." },
