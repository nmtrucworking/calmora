...
export const luxuryLandingCopy: Record<Language, LuxuryLandingCopy> = {
  vi: {
    ...
    finalCta: {
      ...
      secondary: { label: "Đặt trước", href: "/order-request" },
    },
  },
  en: {
    hero: {
    ...
    finalCta: {
      ...
      secondary: { label: "Pre-order", href: "/order-request" },
    },
  },
};
...
export const productLuxuryCopy: Record<Language, Record<ProductId, ProductLuxuryCopy>> = {
  vi: {
    ...
    classic: {
      ...
      secondaryAction: { label: "Đặt trước Classic", href: "/order-request?product=classic" },
      variants: [
  ...
  en: {
    "petal-pack": {
      ...
      secondaryAction: { label: "Pre-order Petal Pack", href: "/order-request?product=petal-pack" },
      variants: [
    ...
    classic: {
      ...
      secondaryAction: { label: "Pre-order Classic", href: "/order-request?product=classic" },
      variants: [
    ...
    "gift-set": {
      ...
      primaryAction: { label: "Register interest", href: "/order-request?product=gift-set" },
