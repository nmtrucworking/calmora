...
- `VITE_PUBLIC_SITE_URL`: public website origin embedded in QR codes generated by admin (for example `https://senova.vn`). It falls back to the current browser origin for local development.
